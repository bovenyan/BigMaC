...
public:
    ...
    std::vector<uint32_t> assoc_fwd_rules;	// IDs of associated fwding rules in the bucket
    std::vector<uint32_t> assoc_mgmt_rules;	// IDs of associated mgmt rules in the bucket
